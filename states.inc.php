...
$machinestates = [
  ...
  ST_PLAY_CARD => [
    ...
    'descriptionairpowertoken' => clienttranslate('${actplayer} may play air power token instead of playing a card'),
    'descriptionmyturnairpowertoken' => clienttranslate('${you} may play air power token instead of playing a card'),
    'type' => 'activeplayer',
    'args' => 'argsPlayCard',
    'action' => 'stPlayCard',
