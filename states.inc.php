...
$machinestates = [
  ...
  ST_ATTACK_RETREAT => [
    ...
    'descriptionskippable' => clienttranslate('${actplayer} may retreat the unit up to ${max} cell(s) (optional)'),
    'descriptionmyturnskippable' => clienttranslate('${you} may retreat the unit up to ${max} cell(s) (optional)'),
    'type' => 'activeplayer',
  ...
  ST_AMBUSH_RESOLVE => [
    'name' => 'ambushResolve',
    'description' => clienttranslate('${actplayer} must retreat the unit ${min} cell(s) ${desc} (Ambush effect)'),
    'descriptionmyturn' => clienttranslate('${you} must retreat the unit ${min} cell(s) ${desc} (Ambush effect)'),
    'descriptionskippable' => clienttranslate('${actplayer} may retreat the unit up to ${max} cell(s) (Ambush effect)'),
    'descriptionmyturnskippable' => clienttranslate('${you} may retreat the unit up to ${max} cell(s) (Ambush effect)'),
    'descriptionbattleBack' => clienttranslate('${actplayer} must retreat the unit ${min} cell(s) ${desc} (Battle back effect)'),
    'descriptionmyturnbattleBack' => clienttranslate('${you} must retreat the unit ${min} cell(s) ${desc} (Battle back effect)'),
    'descriptionbattleBackskippable' => clienttranslate('${actplayer} may retreat the unit up to ${max} cell(s) (Battle back effect)'),
    'descriptionmyturnbattleBackskippable' => clienttranslate('${you} may retreat the unit up to ${max} cell(s) (Battle back effect)'),
    'type' => 'activeplayer',
