...
An Allied unit that captures a town counts as one victory medal. Place an objective medal in each town hex. As long as the Allied unit remains on the town hex, it continues to count toward the Allied victory. If the unit moves off or is eliminated, it no longer counts.'),
      'rules' => clienttranslate('The hill that runs along the beach is a bluff. Moving up the bluff from the beach is a 2 hex move. Tanks may not move up the bluff from the beach. From the inland side, treat the bluff as a normal hill in battle and for movement.

The Axis player is in control of the Bunkers and may claim them as a defensive position.

The Allied Special Force is a Ranger unit. Place a Rangers badge in the same hex as this unit to distinguish it from the other units. Rangers may move 1 or 2 hexes and still battle.

Treat the Sea Wall as a permanent improved position (sandbags) for the Allied player. Place sandbags in these two hexes. Units may move through the seawall as normal. '),
    ],
  ],
];
