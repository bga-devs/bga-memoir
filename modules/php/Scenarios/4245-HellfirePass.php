...
$scenarios[4245] = [
  'meta_data' => [
    ...
    'status' => 'APPROVED',
    'can_translate' => 'true',
    'mod_date' => '2010-06-04 15:04:32',
    'ownerID' => 8860,
    'software' => 'sed 1.2',
    'create_by' => 8860,
    'create_date' => '2008-12-22 18:54:50',
    'mod_by' => 291520,
    'author_id' => 8860,
  ],
  'game_info' => [
    ...
    'options' => ['north_african_desert_rules' => true, 'italy_royal_army' => true, 'partial_blitz_rules' => true],
  ],
  'board' => [
    'type' => 'STANDARD',
    'face' => 'DESERT',
    ...
    'labels' => [
      0 => [
        ...
        'col' => 12,
        'text' => [
          0 => clienttranslate('4th Royal Tank Regiment'),
        ],
      ],
    ],
  ],
