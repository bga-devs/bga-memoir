...
$scenarios[1096] = [
  ...
  'board' => [
    ...
    'labels' => [
      ...
      4 => [
        ...
        'col' => 0,
        'text' => [
          0 => clienttranslate('Units have LoS'),
        ],
      ],
      5 => [
        'row' => 2,
      ...
      20 => [
        ...
        'col' => 17,
        'text' => [
          0 => clienttranslate('No LoS Hill to Hill'),
        ],
      ],
      21 => [
        'row' => 8,
  ...
  'text' => [
    'en' => [
      'name' => clienttranslate('Hills (Examples of Line of Sight )'),
      'historical' => clienttranslate('Example A: Both units have line of sight.
