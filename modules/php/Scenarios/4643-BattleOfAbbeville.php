...
$scenarios[4643] = [
  ...
  'board' => [
    ...
    'labels' => [
      ...
      2 => [
        ...
        'col' => 9,
        'text' => [
          0 => clienttranslate('Mont de Caubert'),
        ],
      ],
      3 => [
        'row' => 4,
        'col' => 14,
        'text' => [
          0 => clienttranslate('Mareuil Caubert'),
        ],
      ],
      4 => [
        'row' => 4,
        'col' => 20,
        'text' => [
          0 => clienttranslate('Villers sur Mareuil'),
        ],
      ],
      5 => [
        'row' => 6,
      ...
      9 => [
        ...
        'col' => 19,
        'text' => [
          0 => clienttranslate('Huchenneville'),
        ],
      ],
      10 => [
        'row' => 8,
        'col' => 2,
        'text' => [
          0 => clienttranslate('Moyenneville'),
        ],
      ],
      11 => [
        'row' => 9,
      ...
      14 => [
        ...
        'col' => 9,
        'text' => [
          0 => clienttranslate('Les Croisettes'),
        ],
      ],
      15 => [
        'row' => 13,
  ...
  'text' => [
    'en' => [
      'name' => clienttranslate('Battle of Abbeville'),
