...
$scenarios[4625] = [
  ...
  'board' => [
    ...
    'labels' => [
      0 => [
        ...
        'col' => 21,
        'text' => [
          0 => clienttranslate('St-Martin'),
          1 => clienttranslate('des Besaces'),
        ],
      ],
      1 => [
        'row' => 3,
        'col' => 9,
        'text' => [
          0 => clienttranslate('La Ferrière'),
          1 => clienttranslate('au Doyen'),
        ],
      ],
      2 => [
        'row' => 3,
      ...
      3 => [
        ...
        'col' => 0,
        'text' => [
          0 => clienttranslate('St-Pierre'),
          1 => clienttranslate('du Fresne'),
        ],
      ],
      4 => [
        'row' => 5,
      ...
      7 => [
        ...
        'col' => 19,
        'text' => [
          0 => clienttranslate('La Morichesse'),
        ],
      ],
      8 => [
        'row' => 11,
      ...
      11 => [
        ...
        'col' => 12,
        'text' => [
          0 => clienttranslate('Caumont'),
          1 => clienttranslate('l\'éventé'),
        ],
      ],
    ],
  ],
  'text' => [
    'en' => [
      'name' => clienttranslate('Coldstream Hill'),
      'subtitle' => clienttranslate('Operation Bluecoat'),
...
You move first.'),
      'rules' => clienttranslate('Place a badge on Allied engineer units (Troops 4 - Combat Engineers) and on Allied "Crocodile" Flame Thrower Tanks (Troops 13 - Flame Thrower Tanks).

Place a badge on the Allied "Sexton" and German "Wespe" Mobile artillery units (Troops 14 - Mobile Artillery).

Place a badge on the German "Jagdpanther" and "Tiger II" elite tank units and another on the German Grenadier infantry units (Troops 2 - Specialized Units).

The German player lays out the Minefields (Terrain 29 - Minefields).

Air Rules are optional: If used, shuffle both Air Sortie cards into the deck before game start.'),
      'historical' => clienttranslate('Taking advantage of the departure of two Panzer Divisions hastily sent west to counter the 1st US Army\'s Operation Cobra, Montgomery sends the 2nd British Army to the assault of the Virois bocage in Operation Bluecoat. Their first objectives are two heights to the east of Saint-Martin-des-Besaces: Hill 226 and Hill 309. On July 30, the German front lines, held by the 276 and 326 Infantry Divisions who were entrenched behind minefields, are bombarded and then eviscerated by the assault of the 15th "Scottish Division" and 43rd "Wessex Division" along with support from the "Crocodile" flame thrower tanks of the 141st RAC.
...
Hill 226 and Hill 309 are Temporary Medal Objectives for the Allied forces.'),
    ],
  ],
];
