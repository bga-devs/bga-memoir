...
$scenarios[1340] = [
  'meta_data' => [
    ...
    'status' => 'APPROVED',
    'can_translate' => 'false',
    'mod_date' => '2010-05-29 06:31:10',
    'ownerID' => 8860,
    'software' => 'sed 1.2',
    'create_by' => 8860,
    'create_date' => '2008-04-07 17:37:02',
    'mod_by' => 291520,
    'author_id' => 8860,
  ],
  'game_info' => [
  ...
  'text' => [
    'en' => [
      'name' => clienttranslate('Across the River Roer'),
      'subtitle' => clienttranslate('Operation Grenade'),
      'historical' => clienttranslate('The 9th Army was lined up along the River Roer on the 23rd of February at the start of Operation Grenade. The river had receded enough to make a crossing possible and the Operation opened with a tremendous artillery bombardment.
...
An Allied unit that captures a town or the medal on the road exit on the Axis baseline, as indicated, counts as one Victory Medal. Place an Objective Medal on each of these hexes. As long as the Allied unit remains on the hex, it continues to count toward the Allied victory. If the unit moves off or is eliminated, it no longer counts.'),
      'rules' => clienttranslate('The River Roer is a Navigable River by Allied infantry units in boats.  Play the river as a Ford (see p. 6)
