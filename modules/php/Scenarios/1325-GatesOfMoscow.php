...
$scenarios[1325] = [
  'meta_data' => [
    ...
    'status' => 'APPROVED',
    'can_translate' => 'false',
    'mod_date' => '2010-05-31 06:53:01',
    'ownerID' => 8860,
    'software' => 'sed 1.2',
    'create_by' => 8860,
    'create_date' => '2008-04-07 17:43:50',
    'mod_by' => 291520,
    'author_id' => 8860,
  ],
  'game_info' => [
  ...
  'text' => [
    'en' => [
      'name' => clienttranslate('Gates of Moscow'),
      'subtitle' => clienttranslate('Unternehmen Taifun'),
      'historical' => clienttranslate('In October, the German High Command launched the final offensive of 1941 - Operation Typhoon. The initial German success on the Eastern Front had put them deep into the Soviet Union on all fronts, but the advance slowed before they could reach the key cities of Mother Russia. The Soviets used their large population to continuously produce more military forces. Although poorly equipped and inexpertly led, the Soviet soldiers were deployed in a last desperate line of defense to keep the German army from reaching Moscow.
...
Russian Player: Take 5 Command cards.'),
      'victory' => clienttranslate('7 Medals
