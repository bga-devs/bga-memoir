...
$scenarios[4246] = [
  'meta_data' => [
    ...
    'original_id' => 4246,
    'create_by' => 8860,
    'create_date' => '2008-10-22 00:14:07',
    'mod_by' => 291520,
    'mod_date' => '2010-06-04 15:06:34',
    'ownerID' => 8860,
    'author_id' => 8860,
    'software' => 'sed 1.2',
  ],
  ...
  'board' => [
    ...
    'labels' => [
      ...
      1 => [
        ...
        'col' => 14,
        'text' => [
          0 => clienttranslate('7th Armoured Division'),
        ],
      ],
    ],
  ],
...
The stage is set, the battle lines drawn, and you are in command. The rest is history.'),
      'name' => clienttranslate('Sidi Rezegh Airfield'),
