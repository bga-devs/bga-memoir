...
const ST_ATTACK = 7;
const ST_OPPONENT_AMBUSH = 8;
const ST_AMBUSH_RESOLVE = 9;
const ST_ATTACK_THROW = 11;
const ST_ATTACK_RETREAT = 12;
const ST_ARMOR_OVERRUN_MOVE = 13;
const ST_ARMOR_OVERRUN_ATTACK = 14;
const ST_ARMOR_OPPONENT_AMBUSH = 15;
const ST_ARMOR_AMBUSH_RESOLVE = 16;
const ST_ARMOR_THROW = 17;
const ST_ARMOR_OVERRUN_RETREAT = 18;
